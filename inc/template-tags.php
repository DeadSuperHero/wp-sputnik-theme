...
if ( ! function_exists( 'sputnik_posted_by' ) ) :
	...
	function sputnik_posted_by() {
		$byline = sprintf(
			...
			'<span class="author vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">' . esc_html(get_avatar( get_the_author_meta( 'ID' ) ) ) . esc_html( get_the_author() ) . '</a></span>'
		);
